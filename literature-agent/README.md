...
For a detailed stage-by-stage workflow, see [SYSTEM_WORKFLOW.md](./SYSTEM_WORKFLOW.md).
...
1. Pull the `search_mcp` project from your internal repository.
2. Configure and start it per that project’s README (default expects port `12400`).
3. Change the URL/transport in `tools.json` if your service differs.
